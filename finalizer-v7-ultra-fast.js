...
const customInterval = intervalIndex !== -1 && args[intervalIndex + 1] 
  ? parseInt(args[intervalIndex + 1]) * 1000  // Convert seconds to milliseconds
  : 30000; // Default 30 seconds

const CONFIG = {
  // Contract details (V7 Multi-Token Contract)
  CONTRACT_ADDRESS: "0xBd32ce277D91b6beD459454C7964528f54A54f75", // NadRaffle V7 Monad Testnet
  ...
  // Finalizer settings
  CHECK_INTERVAL: customInterval, // Custom interval or default 30 seconds
...
// Contract ABI (only functions we need - V7 includes ticketPaymentToken)
const RAFFLE_ABI = [
  ...
  "function getRaffleDetails(uint256 raffleId) external view returns (tuple(address creator, uint256 ticketPrice, address ticketPaymentToken, uint256 maxTickets, uint256 soldTickets, uint256 startTime, uint256 endTime, uint256 rewardAmount, uint8 rewardType, address rewardTokenAddress, uint256 rewardTokenId, uint8 state, address winner))",
...
// ═══════════════════════════════════════════════════════════════════
//                         ULTRA FAST FINALIZER V7
// ═══════════════════════════════════════════════════════════════════

class UltraFastFinalizerV7 {
  constructor() {
    ...
    this.log("🚀 Ultra Fast Finalizer V7 (Multi-Token) Initialized", "INFO");
  ...
  async finalizeSoldOutRaffle(raffleId) {
    ...
    try {
      ...
      // V7 includes payment token info
      if (raffleDetails.ticketPaymentToken && raffleDetails.ticketPaymentToken !== '0x0000000000000000000000000000000000000000') {
        this.log(`💰 Payment token: ${raffleDetails.ticketPaymentToken}`, "DEBUG");
      }
  ...
  async start() {
    ...
    this.isRunning = true;
    this.log(`🚀 Ultra Fast Finalizer V7 started with ${CONFIG.CHECK_INTERVAL / 1000}s intervals`, "INFO");
    this.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━", "INFO");
...
console.log("🎯 NADRAFFLE V7 ULTRA FAST FINALIZER (Multi-Token)");
console.log("═══════════════════════════════════════════════════════════════════");

const finalizer = new UltraFastFinalizerV7();
