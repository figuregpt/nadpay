  ...
  },
  {
    "inputs": [
      ...
      },
      {
        ...
        "internalType": "struct NadSwapV3.Asset[]",
        "name": "_offeredAssets",
        "type": "tuple[]"
      },
      {
...
export const NADSWAP_V3_ADDRESS = '0x982403dcb43b6aaD6E5425CC360fDBbc81FB6a3f' as const;